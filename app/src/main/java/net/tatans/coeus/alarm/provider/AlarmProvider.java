package net.tatans.coeus.alarm.provider;
...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("net.tatans.coeus.alarm", "alarm", ALARMS);
        sURLMatcher.addURI("net.tatans.coeus.alarm", "alarm/#", ALARMS_ID);
    }
