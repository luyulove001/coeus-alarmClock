...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "net.tatans.coeus.alarm.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "net.tatans.coeus.alarm.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "net.tatans.coeus.alarm.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "net.tatans.coeus.alarm.ALARM_DISMISS";
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(AlarmClockApplication.PREFERENCES, 0);
    ...
    public static void saveSnoozeAlert(final Context context, final int id,
        ...
        SharedPreferences prefs = context.getSharedPreferences(
                AlarmClockApplication.PREFERENCES, 0);
        if (id == -1) {
            clearSnoozePreference(context, prefs);
        } else {
